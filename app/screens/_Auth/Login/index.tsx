...
import { BaseView, Text, Input, Spacer, Button } from '@components/index';
...
const Screen = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Text.Header>Masuk</Text.Header>
        <Text.Desc>Silakan masuk dengan No. HP yang terdaftar</Text.Desc>
        <Input
          label="Username"
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <Text.Desc style={{ margin: spacing.sm }}>
            Atau daftar sebagai
          </Text.Desc>
          <View style={styles.line} />
        </View>
