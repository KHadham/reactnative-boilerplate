...
const data = [
  {
    ...
    desc: 'PTPN meminta izin akses notifikasi untuk mengirim info notifikasi',
    type: 'notification',
    icon: 'bell-ring',
  },
  {
    ...
    desc: 'PTPN meminta izin akses kamera untuk memperbarui profil anda dan kegiatan penngambilan gambar untuk survey anda',
    type: 'camera',
    icon: 'camera-plus',
  },
  {
    ...
    desc: 'PTPN meminta izin akses galeri untuk memperbarui profil anda dan kegiatan penngambilan gambar untuk kegiatan survey anda',
    type: 'gallery',
    icon: 'camera-image',
  },
  {
    ...
    desc: 'PTPN meminta izin akses lokasi untuk setiap kegiatan survey yang anda buat',
    type: 'location',
