...
import { COLOR_BASE_PRIMARY_MAIN, COLOR_GREY, COLOR_WHITE } from '@themes/index';
  ...
  return (
    <BaseView>
      <FlatList
        ...
        ListHeaderComponent={() => (
          <View style={{ padding: spacing.md, paddingTop: spacing.xs,backgroundColor:COLOR_WHITE }}>
